...
y_message = AWGN_Channel(message_bi, var);
y_u1 = AWGN_Channel(u1_bi, var);
y_u2 = AWGN_Channel(u2_bi, var);
% plot(t, out_signal);
...
sum(xor(input_code, final_result))
sum(xor(input_code, final_result))/length(input_code)
